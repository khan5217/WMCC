...
export const metadata: Metadata = {
  title: '1st XI',
  description: 'WMCC Milton Keynes Cricket Club 1st XI squad and player profiles.',
}
...
export default async function FirstXIPage() {
    ...
    include: {
      ...
      players: {
        ...
        include: {
          ...
          performances: { select: { runs: true, wickets: true, isOut: true } },
        },
      },
    },
    orderBy: { season: 'desc' },
    ...
    <>
      <div className="hero-gradient pt-24 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white font-serif mb-2">1st XI</h1>
          {team && (
        ...
        <div className="container-max">
          {!team || team.players.length === 0 ? (
            <div className="text-center py-16 text-gray-400">
              ...
              <p>No players listed in the 1st XI yet.</p>
            </div>
          ) : (
